...
function Homepage({ streams, setCategoryStreams, setCategoryVideos }) {
  ...
  return (
    <>
      ...
      <div>{technologies.map(tech => <TechnologyCard key={tech.name} tech={tech} streams={streams} setCategoryStreams={setCategoryStreams} setCategoryVideos={setCategoryVideos}/>)}</div>
