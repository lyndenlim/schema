  ...
  return (
    <div style={{paddingTop: "100px"}}>
      <div className="centered">
        {searchedStreams.length > 0 ? <h4 className="bold text-white">Streams</h4> : <div><h4 className="bold text-white">Streams</h4><h6 className="text-white">No one is currently streaming</h6></div>}
      </div>
