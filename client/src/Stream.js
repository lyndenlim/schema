    ...
    return (
        <div className="twitch-content" style={{ paddingTop: "100px" }}>
            <div>
                <iframe
                    title={id}
                    src={`https://player.twitch.tv/?channel=${streams[0].user_name}&parent=localhost&parent=https://schema-project.herokuapp.com/`}
                    width="1120px"
                    height="500px"
            ...
            <iframe
                title={id}
                src={`https://www.twitch.tv/embed/${streams[0].user_name}/chat?parent=localhost&parent=https://schema-project.herokuapp.com/`}
                height="500px"
                width="300px">
            </iframe>
        </div>
